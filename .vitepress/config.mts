  ...
  '/guide/': [
    {
      text: '🔥 最新教程',
      items: [
        { text: '1', link: '/guide/auto-article-1777430864899' },
        { text: 'gemini中文版 2026', link: '/guide/auto-article-1777391783327' },
        { text: 'Gemini中文版 2026完整使用指南｜国内访问教程+最新功能详解', link: '/guide/gemini-chinese-version-2026-complete-guide-428' },
        ...
        { text: 'Gemini vs ChatGPT 2026：深度对比测评，谁才是最强AI助手？', link: '/guide/gemini-vs-chatgpt-2026-comparison-april-2026-424' },
        { text: 'Google Gemini 国内怎么用？2026年4月完整使用指南', link: '/guide/google-gemini-how-to-use-in-china-2026-04-423' },
        ...
        { text: 'Gemini 3.1 Pro 教程：2026年4月国内完整使用指南', link: '/guide/gemini-31-pro-tutorial-complete-guide-april-2026-420' },
        { text: 'Google Gemini 国内怎么用？2026年4月完整使用教程', link: '/guide/google-gemini-how-to-use-in-china-2026-04' },
